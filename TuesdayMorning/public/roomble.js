...
//
//   var photo = childSnapshot.val().link;
...
//   });
// });
// $("#photo").append("<p>" + photo + "</p><p> " + userID + "</p><br>");
  ...
  firebaseRef.once("value", function(snapshot){
    ...
    //   document.querySelector('#root').innerHTML=`<div>${element}</div>`
    // });

  });
  // var userID = firebase.auth().currentUser.uid;
  // //CHECK THIS LINE BELOW IF ITS THE CORRECT WAY TO ACCESS USERS IN DATABASE
